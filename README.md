...
- **Match highlighting** — match cards are colour-coded by the user's own response: **blue** glow for At Home, **green** glow for Together; when ≥50% of unique group members who have responded chose Together (minimum 2 responders, deduplicated across shared groups), the card gets a pulsating **gold** "Match on" glow and tag that overrides the personal colour
